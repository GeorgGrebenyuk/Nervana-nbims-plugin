...
1. Идём по пути `C:\Program Files (x86)\CSoft\Model Studio CS\Library\bin\x64` или в иное место, где установлена программа "Менеджер библиотек стандартных компонентов";
