...
Настоящее руководство посвящено набору утилит преимущественно к nanoCAD BIM Строительство и ModelStudio CS под общим названием "Nervana". Весь исходный код команд и утилит открыт и размещен на GitHub под лицензией GPL3.0:

https://github.com/GeorgGrebenyuk/Nervana-nbims-plugin
